                            ...
                            <tr key={item.id} style={{ borderColor: item.color, borderWidth: '2px', borderStyle: 'solid' }}>
                                ...
                                <td>
                                    <select onChange={handleColorChange}>
                                        ...
                                        <option value={item.color}>Aero</option>
                                        <option value={item.color}>Azure</option>
                                        <option value={item.color}>Beige</option>
                                        <option value={item.color}>Brown</option>
                                        <option value={item.color}>Black</option>
                                        <option value={item.color}>Blue</option>
